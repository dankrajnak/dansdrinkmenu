...
export type Query = {
  ...
  sanityDrink?: Maybe<SanityDrink>;
  allSanityDrink: SanityDrinkConnection;
...
export type QuerySanityDrinkArgs = {
...
export type QueryAllSanityDrinkArgs = {
  filter?: Maybe<SanityDrinkFilterInput>;
  sort?: Maybe<SanityDrinkSortInput>;
  skip?: Maybe<Scalars['Int']>;
  limit?: Maybe<Scalars['Int']>;
};
...
export type SanityDrink = SanityDocument & Node & {
  _id?: Maybe<Scalars['String']>;
  _type?: Maybe<Scalars['String']>;
  _createdAt?: Maybe<Scalars['Date']>;
  _updatedAt?: Maybe<Scalars['Date']>;
...
export type SanityDrink_CreatedAtArgs = {
  formatString?: Maybe<Scalars['String']>;
  fromNow?: Maybe<Scalars['Boolean']>;
  difference?: Maybe<Scalars['String']>;
  locale?: Maybe<Scalars['String']>;
...
export type SanityDrink_UpdatedAtArgs = {
  formatString?: Maybe<Scalars['String']>;
  fromNow?: Maybe<Scalars['Boolean']>;
  difference?: Maybe<Scalars['String']>;
  locale?: Maybe<Scalars['String']>;
...
export type SanityDrinkConnection = {
  totalCount: Scalars['Int'];
  edges: Array<SanityDrinkEdge>;
  nodes: Array<SanityDrink>;
  pageInfo: PageInfo;
  distinct: Array<Scalars['String']>;
  group: Array<SanityDrinkGroupConnection>;
};


export type SanityDrinkConnectionDistinctArgs = {
  field: SanityDrinkFieldsEnum;
};


export type SanityDrinkConnectionGroupArgs = {
  skip?: Maybe<Scalars['Int']>;
  limit?: Maybe<Scalars['Int']>;
  field: SanityDrinkFieldsEnum;
};

export type SanityDrinkEdge = {
  next?: Maybe<SanityDrink>;
  node: SanityDrink;
  previous?: Maybe<SanityDrink>;
};

export type SanityDrinkFieldsEnum = 
  | '_id'
  | '_type'
  | '_createdAt'
  | '_updatedAt'
...
export type SanityDrinkFilterInput = {
  _id?: Maybe<StringQueryOperatorInput>;
  _type?: Maybe<StringQueryOperatorInput>;
  _createdAt?: Maybe<DateQueryOperatorInput>;
  _updatedAt?: Maybe<DateQueryOperatorInput>;
...
export type SanityDrinkGroupConnection = {
  totalCount: Scalars['Int'];
  edges: Array<SanityDrinkEdge>;
  nodes: Array<SanityDrink>;
  pageInfo: PageInfo;
...
export type SanityDrinkSortInput = {
  fields?: Maybe<Array<Maybe<SanityDrinkFieldsEnum>>>;
  order?: Maybe<Array<Maybe<SortOrderEnum>>>;
};
...
export type DrinksQuery = { allSanityDrink: { nodes: Array<Pick<SanityDrink, 'id' | 'name' | 'description' | 'order'>> } };
